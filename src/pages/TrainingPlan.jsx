...
const trainingPlan = [
  ...
  { week: 7, runs: [{ day: 'Monday', type: 'Easy Run', distance: '4 mi' }, { day: 'Wednesday', type: 'Tempo', distance: '6 mi' }, { day: 'Saturday', type: 'Long Run', distance: '9 mi' }] },
  { week: 8, runs: [{ day: 'Monday', type: 'Easy Run', distance: '3 mi' }, { day: 'Wednesday', type: 'Easy Run', distance: '4 mi' }, { day: 'Saturday', type: 'Long Run', distance: '7 mi' }] },
  { week: 9, runs: [{ day: 'Monday', type: 'Easy Run', distance: '5 mi' }, { day: 'Wednesday', type: 'Tempo', distance: '6 mi' }, { day: 'Saturday', type: 'Long Run', distance: '10 mi' }] },
  { week: 10, runs: [{ day: 'Monday', type: 'Easy Run', distance: '5 mi' }, { day: 'Wednesday', type: 'Tempo', distance: '6 mi' }, { day: 'Saturday', type: 'Long Run', distance: '11 mi' }] },
